...
func (in *ActionSelector) DeepCopyInto(out *ActionSelector) {
	*out = *in
	if in.EnforcerNotifyActionArgIndex != nil {
		in, out := &in.EnforcerNotifyActionArgIndex, &out.EnforcerNotifyActionArgIndex
		*out = new(uint32)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KprobeIgnore) DeepCopyInto(out *KprobeIgnore) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KprobeIgnore.
func (in *KprobeIgnore) DeepCopy() *KprobeIgnore {
	if in == nil {
		return nil
	}
	out := new(KprobeIgnore)
...
func (in *TracingPolicySpec) DeepCopyInto(out *TracingPolicySpec) {
	*out = *in
	...
	if in.Usdts != nil {
		in, out := &in.Usdts, &out.Usdts
		*out = make([]UsdtSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsdtSpec) DeepCopyInto(out *UsdtSpec) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsdtSpec.
